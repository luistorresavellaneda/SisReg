        ...
        <div class="container-fluid">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              ...
              <li id="rol3"><a href="<c:url value="listado" />">Reporte de avance (Docente - Delegado)</a></li>
      	...
      	<div class="col-md-12">
      		<div class="col-md-4">
      			<div class="form-group">
				   ...
				   <select class="form-control" id="curso4" name="curso4" onchange="ActionCurso2(this.value,'grupo3');">
				   		<option value="0">Seleccione</option>
<!-- 				   		<option value="sscalc1">CALCULO I</option> -->
				   </select>				   	
				 </div>
      		</div>
      		<div class="col-md-4">
      			<div class="form-group">
				   ...
				   <select class="form-control" id="grupo3" name="grupo3">
				   		<option value="0">Seleccione</option>
    ...
    <script>
        ...
        function obtenerUsuario(){
        	$.ajax({
        		...
        		{
        			$("#usuario").text(result);
        			cargarCursosPerfil('curso4', result);
        		},
